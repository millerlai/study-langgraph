...
> 📄 完整範例程式碼：[9.1-example-shared-schema.py](./9.1-example-shared-schema.py)
...
> 📄 完整範例程式碼：[9.1-example-different-schema.py](./9.1-example-different-schema.py)
...
```mermaid
graph TD
    subgraph Thread["Thread: thread-001"]
        subgraph NS_Parent["Namespace: 空字串（父圖）"]
            CP0["checkpoint_0: plan state"]
            CP1["checkpoint_1: after research state"]
            CP2["checkpoint_2: final state"]
        end
        subgraph NS_Research["Namespace: research（子圖）"]
            CP3["checkpoint_0: gather state"]
            CP4["checkpoint_1: analyze state"]
        end
    end
```
...
> 📄 完整範例程式碼：[9.1-example-checkpoint-namespace.py](./9.1-example-checkpoint-namespace.py)
...
> 📄 完整範例程式碼：[9.1-example-multi-layer-subgraph.py](./9.1-example-multi-layer-subgraph.py)
