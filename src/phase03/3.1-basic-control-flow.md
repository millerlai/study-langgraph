...
> 📄 完整範例程式碼：[3.1-example-sequential.py](./3.1-example-sequential.py)
...
graph LR
    ...
    analyze -->|positive| positive["positive"]
    analyze -->|neutral| neutral["neutral"]
    analyze -->|negative| negative["negative"]
    positive --> END(["END"])
    neutral --> END
    negative --> END
```
...
> 📄 完整範例程式碼：[3.1-example-conditional-branching.py](./3.1-example-conditional-branching.py)
...
> 📄 完整範例程式碼：[3.1-example-loop.py](./3.1-example-loop.py)
...
```mermaid
graph TD
    START(["START"]) --> thinking["thinking"]
    thinking -->|finish| END(["END"])
    thinking --> tool_search["tool_search"]
    thinking --> tool_calc["tool_calc"]
    thinking --> tool_lookup["tool_lookup"]
    tool_search --> thinking
    tool_calc --> thinking
    tool_lookup --> thinking
```
...
> 📄 完整範例程式碼：[3.1-example-multi-tool-agent.py](./3.1-example-multi-tool-agent.py)
...
> 📄 完整範例程式碼：[3.1-example-command-loop.py](./3.1-example-command-loop.py)
